...
# print("Atividade 1 concluída: Tabela criada.")import sqlite3
...
# --- ATUALIZAR (Update) ---
# Vamos atualizar o email do Matheus Hideo
cursor.execute("UPDATE clientes SET email = 'matheus.hideo@mail.com' WHERE nome = 'Matheus Hideo'")

# --- DELETAR (Delete) ---
# Vamos deletar o registro do Lucas Freitas
